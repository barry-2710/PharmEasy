     ...
     <?php include "navbar.php"; ?>
        ...
        <?php    
           ...
           <div class="products p-4 bg-light">
                ...
                $sql = "SELECT product_id, name, description,image,category,MRP,final_cost, created_at FROM products WHERE category='product' LIMIT $offset, $no_of_records_per_page";
                $res=$db->query($sql);
                if($res->num_rows>0){
                    $i=0;
